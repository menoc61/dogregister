...
{               ?>
                ...
                <div class="left-custom-menu-adp-wrap">
                    <ul class="nav navbar-nav left-sidebar-menu-pro">
                        ...
                        <li class="nav-item"><a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle"><i class="fa big-icon fa-table"></i> <span class="mini-dn">Applications</span> <span class="indicator-right-menu mini-dn"><i class="fa indicator-mn fa-angle-left"></i></span></a>
                        ...
                        <li class="nav-item">
                            <a href="add-microsim-id.php" role="button" aria-expanded="false">🔗<span class="mini-dn">Add Microsim-ID</span> </a>        
                        </li>                        
                    </ul>
                </div>
            </nav>
