...
<head>
    ...
    <title>Dashboard | Online Dog Certificate System</title>
...
{               ?> 
                                        <div class="main-income-phara">
                                           <h2>Welcome <?php  echo $row->FirstName;?> <?php  echo $row->LastName;?> to the Dog Registration.</h2>
                                          <br> <h4>Your Data have been saved successfully!</h4>
                                        </div>
                                        <?php $cnt=$cnt+1;}} ?>
                                    </div>
                                </div>
